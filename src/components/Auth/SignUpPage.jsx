...
import { Mail, Lock, User, UserPlus, Sparkles, Eye, EyeOff, Loader2, CheckCircle2 } from 'lucide-react'
...
const SignUpPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 2. Update auth profile with full name so displayName is available
            ...
            setSuccess('Account created successfully! Your adventure begins.')
